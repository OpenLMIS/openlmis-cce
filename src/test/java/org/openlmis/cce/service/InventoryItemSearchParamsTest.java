...
public class InventoryItemSearchParamsTest {

  @Test
  public void equalsContract() {
    EqualsVerifier.forClass(InventoryItemSearchParams.class)
        .suppress(Warning.NONFINAL_FIELDS) //We need them mutable
        .verify();
  }
  ...
  public void shouldImplementToString() {
    ...
    ToStringTestUtils.verify(InventoryItemSearchParams.class, params);
  }
