# OpenLMIS CCE Service
This repository holds tyhe files for the OpenLMIS Cold Chain Equipment Service.
...
1. Fork/clone this repository from GitHub.
 ...
 ```
2. Respectively change all instances of `openlmis-cce` and
